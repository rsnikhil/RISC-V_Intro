...
\begin{center}
  ...
  \begin{minipage}{6in}\Large
    ...
    \item Verification
      \begin{itemize}
      \item Formal Specification of RISC-C ISA
    ...
    \begin{minipage}{9in}\LARGE
      \begin{itemize}
        ...
        \item RISC-V seems well on its way to becoming one of the
          three dominant ISAs (along with x86 and ARM).  Over time, it
          may also displace the numerous lesser-known ISAs used for
          microcontrollers.
